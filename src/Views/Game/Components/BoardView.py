...
from src.Views.Game.Components.CellView import CellView
from src.Utils.Enums.Constants import UIConfig, UIColors
...
class BoardView:
    ...
    def update(self, highlight_cells=None, highlight_invalid_cells=None, ship_hover_cells=None, ship_selected_cells=None,
        ...
        Args:
            ...
            hide_ships_mines: True if ships and mines should be hidden (default: False)
        """
